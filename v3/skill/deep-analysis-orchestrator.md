...
### Krok 1a: przeszukaj forlder material_input - powinien być w projekcie w którym aktualnie będziesz prowadził analizę,
Jeżeli go nie ma lub jest pusty, wyświetl użytkownikowi informacje że nie znalazłeś materiałów wejściowych do analizy.
...
Ale pozwól wybrać użytkowink Tryb pracy - patrz sekcja Tyrb Pracy, nie wybieraj za nie go nawet jeżeli brak jest danych albo są nie kompletne albo kompletne.
Ale to właśnie użytkownik musi mieć wybór.
